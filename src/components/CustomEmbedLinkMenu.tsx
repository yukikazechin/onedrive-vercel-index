...
function LinkContainer({title, value}: { title: string; value: string }) {
    ...
    return (
        <>
            ...
            <div
                className="group relative mb-2 max-h-24 overflow-y-scroll break-all rounded border border-gray-400/20 bg-gray-50 p-2.5 font-mono dark:bg-gray-800 !backdrop-blur-md !bg-opacity-50">
    ...
    return (
        <Transition appear show={menuOpen} as={Fragment}>
            ...
            &#8203;
                    ...
                    >
                        <div
                            className="inline-block max-h-[80vh] w-full max-w-3xl transform overflow-hidden overflow-y-scroll rounded border border-gray-400/30 bg-white p-4 text-left align-middle text-sm shadow-xl transition-all dark:bg-gray-900 dark:text-white !backdrop-blur-md !bg-opacity-50">
