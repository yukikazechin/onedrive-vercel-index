...
const Navbar = () => {
    ...
    return (
        <div
            className="sticky top-0 z-[100] border-b border-gray-900/10 bg-white backdrop-blur-md dark:border-gray-500/30 dark:bg-gray-900 !bg-opacity-50">
            <Toaster/>
                ...
                <div className="flex flex-1 items-center space-x-4 text-gray-700 md:flex-initial">
                    ...
                    >
                        ...
                        <div className="hidden items-center space-x-1 md:flex">
                            ...
                            <div className="rounded-lg bg-gray-200 px-2 py-1 text-xs font-medium dark:bg-gray-700">K
                            </div>
                        </div>
                    </button>
            ...
            <Transition appear show={isOpen} as={Fragment}>
                <Dialog as="div" className="fixed inset-0 z-10 overflow-y-auto backdrop-blur-md !bg-opactiy-50"
                    ...
                    <div className="min-h-screen px-4 text-center !bg-opactiy-50">
                        ...
                        <span className="inline-block h-screen align-middle backdrop-blur-md !bg-opactiy-80"
                              aria-hidden="true">
              &#8203;
            </span>
                        <Transition.Child
                        ...
                        >
                            <div
                                className="my-8 inline-block w-full max-w-md transform overflow-hidden rounded-lg bg-white p-6 text-left align-middle transition-all dark:bg-gray-900 backdrop-blur-md !bg-opacity-80">
